...
const dictionaries: Record<Language, DictionaryMap> = {
  zh: {
    ...
    footer: {
      tagline: "面向国内开发者的 AI API 中转服务，兼容 Chat Completions 与 MiniMax M3 Messages。",
      sitemap: "页脚站点地图",
      product: "产品",
      account: "账号",
      developer: "开发者",
    ...
    announcement: {
      ...
      current: "当前 Free 可用：",
      syncing: "当前免费模型池正在同步",
      body: "Free 用户每月 500 次请求额度，可调用实时同步的免费模型池。MiniMax M3 额外免费开放，需走 /v1/messages，且不计入月度额度。",
      list: "免费模型列表",
      unavailable: "暂时不可用",
      syncingShort: "正在同步",
      closeAction: "关闭",
  ...
  en: {
    ...
    footer: {
      tagline: "An AI API relay with OpenAI-compatible chat plus MiniMax M3 messages support.",
    ...
    announcement: {
      ...
      body: "Free users get 500 requests per month and can use the live free model catalog. MiniMax M3 is additionally open for free through /v1/messages and does not count against monthly quota.",
