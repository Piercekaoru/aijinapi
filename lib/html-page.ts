...
function translateStaticHtml(kind: RouteKind, html: string) {
  const replacements: Record<RouteKind, Array<[string, string]>> = {
    landing: [
      ...
      ["Free 开放实时同步的免费模型池，并额外赞助开放 DeepSeek V4 Flash 与 DeepSeek V4 Pro；Plus 开放国产主流模型，后端自动分配模型通道。", "Free users can use the live free model catalog plus sponsored DeepSeek V4 Flash and DeepSeek V4 Pro. Plus unlocks the full paid model pool with automatic backend routing."],
      ...
      ["选择套餐", "Choose a plan"],
      ["Free 可用实时同步的免费模型池，以及赞助开放的 DeepSeek V4 Flash 与 DeepSeek V4 Pro；Plus {{PLUS_MONTHLY_PRICE_TEXT}}，开放主流模型池。", "Free includes the live free model catalog plus sponsored DeepSeek V4 Flash and DeepSeek V4 Pro; Plus {{PLUS_MONTHLY_PRICE_TEXT}} unlocks the mainstream model pool."],
      ["获取 Key", "Get a key"],
    ...
    login: [
      ...
      ["验证邮箱后启用 Free 套餐，每月 500 次请求额度，可调用实时同步的免费模型池，以及赞助开放的 DeepSeek V4 Flash 与 DeepSeek V4 Pro。", "Verify your email to activate the Free plan: 500 monthly requests, the live free model catalog, and sponsored DeepSeek V4 Flash and DeepSeek V4 Pro."],
      ["已提交", "Submitted"],
    ],
    models: [
      ["在一个广场里挑模型，在一套 API 里调用。", "Choose models in one catalog and call them through one API."],
      ["OpenAchieve 将实时同步的免费模型池与 Kimi、GLM、MiMo、Qwen、DeepSeek 等 Plus 模型收束到 OpenAI-compatible 接口。Free 可用免费模型池，以及赞助开放的 DeepSeek V4 Flash 与 DeepSeek V4 Pro；Plus 模型统一自动分配通道。", "OpenAchieve brings the live free model catalog plus sponsored DeepSeek V4 Flash and DeepSeek V4 Pro, along with Kimi, GLM, MiMo, Qwen, and other Plus models, into one OpenAI-compatible endpoint."],
      ["浏览模型", "Browse models"],
